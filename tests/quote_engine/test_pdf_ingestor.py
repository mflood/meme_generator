...
@patch(
    "quote_engine.pdf_ingestor.open",
    new_callable=mock_open,
    read_data='"Life is beautiful" - Anonymous\n"To be or not to be" - Shakespeare\n',
)
...
@patch(
    "quote_engine.pdf_ingestor._convert_pdf_to_text",
    return_value=[
...
@patch(
    "quote_engine.pdf_ingestor._convert_pdf_to_text",
    return_value=["Invalid quote line", '"Valid quote" - Author'],
)
